...
RSpec.describe Post, type: :system do
  describe 'show page' do
    before(:each) do
      ...
      @first_comment = Comment.create(post: @first_post, author: @second_user, text: 'Hi Fernando! First comment')
      @second_comment = Comment.create(post: @first_post, author: @second_user, text: 'Hi Fernando! Second comment')
      Comment.create(post: @first_post, author: @second_user, text: 'Hi Fernando! Third comment')
      Comment.create(post: @first_post, author: @second_user, text: 'Hi Fernando! Fourth comment')
      Comment.create(post: @first_post, author: @second_user, text: 'Hi Fernando! Fifth comment')
      @last_comment = Comment.create(post: @first_post, author: @second_user, text: 'Hi Fernando! Sixth comment')
