...
RSpec.describe User, type: :system do
  describe 'index page' do
    before(:each) do
      ...
      @first_user = User.create(name: 'Fernando', photo: @first_photo, bio: 'Teacher from Brazil.')
      @second_user = User.create(name: 'Amanda', photo: @second_photo, bio: 'Student from USA.')
      @third_user = User.create(name: 'Donald', photo: @first_photo, bio: 'Musician from England.')
      @fourth_user = User.create(name: 'Monica', photo: @second_photo, bio: 'Dancer from Belgium.')
